...
const routes = [
	...
	{
		path: 'temple',
		component: lazy(() => import('@iso/containers/Pages/Screen/Temple/Temple')),
	},
	{
		path: 'temple-details/:id',
		component: lazy(() => import('@iso/containers/Pages/Screen/Temple/TempleDetails')),
	},
	{
		path: 'user',
		component: lazy(() => import('@iso/containers/Pages/Screen/Users/Users')),
	},
	{
		path: 'my-profile',
